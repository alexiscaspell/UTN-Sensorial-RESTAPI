...
def _cast_to_datetime(value):
    ...
    possible_formats = ["%Y-%m-%dT%H:%M:%S.%fZ","%Y-%m-%dT%H:%M", "%Y-%m-%dT%H:%M:%S.%f","%Y-%m-%d %H:%M:%S.%fZ",
                        "%Y-%m-%d %H:%M:%S.%f","%Y-%m-%dT%H:%M:%S", "%Y-%m-%d %H:%M:%S", '%Y-%m-%d %H:%M:%S', "%Y-%m-%dT%H:%M:%SZ","%Y-%m-%dT%H:%M:%S.%f+00:00","%Y-%m-%dT%H:%M:%S.%f-03:00"]
